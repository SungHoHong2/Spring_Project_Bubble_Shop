...
public class AdminController {
			...
			Form_Data fd)
	{
		...
		switch(service)
		{
			...
			case "reg_detail_purchase2":
				System.out.println("reg_detatil : "+request.getParameter("idtest"));
				bean.setBp_id(Integer.parseInt(request.getParameter("idtest")));
				bean.setData(repository.regdetail_purchase(bean));		
				System.out.println("finish");
				bean.setUrl("bs/admin/goods/reg_detail_purchase2");
				bean.setRedirect(true);
			break;
			
			case "reg_detail_purchase3":
				System.out.println("reg_detatil : "+request.getParameter("idtest"));
				bean.setBp_id(Integer.parseInt(request.getParameter("idtest")));
				bean.setData(repository.regdetail_purchase(bean));		
				System.out.println("finish");
				bean.setUrl("bs/admin/goods/reg_detail_purchase3");
				bean.setRedirect(true);
			break;
			...
			case "reg_detail_purchase_detail2":
				System.out.println("reg_detail_purchase_detail :"+request.getParameter("idtest"));
				bean.setG_code(Integer.parseInt(request.getParameter("idtest")));
				bean.setData(repository.regdetail(bean));				
				bean.setUrl("bs/admin/goods/reg_detail_purchase_detail");
			...
			case "reg_detail_purchase_detail3":
				System.out.println("reg_detail_purchase_detail :"+request.getParameter("idtest"));
				bean.setG_code(Integer.parseInt(request.getParameter("idtest")));
				bean.setData(repository.regdetail(bean));				
				bean.setUrl("bs/admin/goods/reg_detail_purchase_detail");
			...
			case "reg_widget2_data" :
				bean.setData(repository.display_product());
			...
			case "purchase_finished" :
				...
				bean.setBq_total(buffing);
				bean.setData(repository.admin_purchase_finished());	
			break;
			
			case "purchase_finished_loop" :
				
				   SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
		
				   System.out.println("purchase_finished_loop : "+bean.getBq_reg_date_start_string());
				   System.out.println("purchase_finished_loop : "+bean.getBq_reg_date_end_string());

			try {
				bean.setBq_reg_date_start(formatter.parse(bean.getBq_reg_date_start_string()));
				bean.setBq_reg_date_end(formatter.parse(bean.getBq_reg_date_end_string()));
			} catch (ParseException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
				  
			    bean.setData(repository.purchase_finished_loop(bean));
				
			break;
			
			case "purchase_finished_total" :
				String buff1 = request.getParameter("startids");
				String buff2 = request.getParameter("endids");
					
				System.out.println(buff1+" : "+buff2);
				bean.setBq_reg_date_start_string(buff1);;
				bean.setBq_reg_date_end_string(buff2);
				
				bean.setTotal((int)repository.purchase_finished_total(bean));
				
				bean.setUrl("bs/admin/admin_purchase/purchase_finished_total");
				bean.setRedirect(true);
			break;
			...
			case "refunds" :
				...
				bean.setData(repository.refunds());

		...
		<script type="text/javascript">
			$(document).ready(function(){
			    ...
			    zipSearch = function(){
			    	...
			    	window.open("/shop/resources/zipcode_sch2.jsp?post1=zip1&post2=zip2&addr1=bs_address&addr2=bs_address2", "pop_zipcode", "width=600, height=490, toolbar=no, location=no, status=no, menubar=no, scrollbars=yes, resizable=yes, left=300, top=200")
			    }

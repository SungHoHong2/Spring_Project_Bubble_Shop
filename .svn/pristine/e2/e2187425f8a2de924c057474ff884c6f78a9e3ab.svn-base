	...
	<table class="brd_table">
		...
		<tr>
			...
			<th>
					...
					<c:if test="${session_rate==10 }"><a class="writenoti" href="#" onclick="write_go(); return;">글쓰기</a></c:if>
			</th>
		</tr>
		<tr>
			<th>글번호</th>
				...
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:otherwise>
								<img src="/shop/resources/images/notice_event.png" width="30px" height="15px" />
							</c:otherwise>
						</c:choose>	
					</td>

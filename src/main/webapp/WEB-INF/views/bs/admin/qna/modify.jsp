...
<div class="hong_template">
	...
	<form name="frm" method="post" action="" enctype="multipart/form-data">
		...
		<table class="brd_detail">
			...
			<tr>
				<th>암호</th>
				<td><input type="password" id="notice_pw" title="암호" name="notice_pw"></td>
			</tr>
			<tr>
				<th>내용</th>
				<td>
		...
		<c:if test="${bean.data.notice_seq==0 }">
				<tr id="tr_file">
					<c:choose>
						<c:when test="${bean.data.notice_upfile=='' || bean.data.notice_upfile==null || bean.data.notice_upfile=='null'}">
							<th>파일첨부</th>
